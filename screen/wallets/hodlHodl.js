...
export default class HodlHodl extends Component {
  ...
  /**
   * We do 2 api calls, to fetch buy offers and to fetch sell offers,
   * and we set those orders into state
   *
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'position' : null}>
          <View style={styles.modalContentShort}>
            <FlatList
              ...
              data={[{ code: TABS.BUY, native_name: "I'm buying bitcoin" }, { code: TABS.SELL, native_name: "I'm selling bitcoin" }]}
              ...
              renderItem={({ item, index, separators }) => (
                ...
                >
                  <View style={{ backgroundColor: 'white', flex: 1, flexDirection: 'row', paddingTop: 20 }}>
                    <Text style={{ color: '#0c2550', fontWeight: this.state.currentTab === item.code ? 'bold' : 'normal' }}>
                      {item.native_name}
                    </Text>
                  </View>
                </TouchableHighlight>
      ...
      <View>
        <BlueCard style={{ alignItems: 'center', flex: 1 }}>
          <View style={{ flexDirection: 'row' }}>
            <Text style={styles.Title}>The Corner </Text>
            <TouchableOpacity
            ...
            >
              <Text style={styles.grayDropdownText}>{this.state.currentTab === TABS.BUY ? 'Buying' : 'Selling'}</Text>

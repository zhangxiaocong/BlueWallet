...
import { BlueNavigationStyle, BlueLoading, BlueCard, BlueSpacing20, BlueButton } from '../../BlueComponents';
...
export default class HodlHodl extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      sellOffers: [],
      buyOffers: [],
      country: HodlHodlApi.FILTERS_COUNTRY_VALUE_GLOBAL, // country currently selected by user to display orders on screen
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'position' : null}>
          <View style={styles.modalContent}>
            <View>
              ...
              <BlueSpacing20 />
              <BlueButton
                title={'Im selling bitcoin'}
                onPress={() => {
                  this.setState({
                    isChooseSideModalVisible: false,
                    currentTab: TABS.SELL,
                  });
                }}
              />
            </View>
      ...
      <View>
        <BlueCard style={{ alignItems: 'center', flex: 1 }}>
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={styles.grayDropdownTextContainer}>
              <Text
                onPress={() => {
                  this.setState({ isChooseSideModalVisible: true });
                }}
                style={styles.grayDropdownText}
              >
                {this.state.currentTab === TABS.BUY ? 'Buying ' : 'Selling '} ˅
              </Text>
            </View>
          </View>
          ...
          <View style={styles.grayTextContainerContainer}>
            <View style={styles.grayTextContainer}>
              ...
              <Text style={styles.locationText} onPress={() => this.changeCountry()}>
                🗺 {this.state.country === this.state.myCountryCode ? 'Near me' : 'Global offers'}
              </Text>
